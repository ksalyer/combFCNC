...
with open('2023aug18_sepScl_full_combined_tuh.txt','r') as f_tuh:
    l_tuh = f_tuh.readlines()
f_tuh.close()
print("loaded tuh datacard")

with open('2023aug18_sepScl_full_combined_tch.txt','r') as f_tch:
    l_tch = f_tch.readlines()
f_tch.close()
print("loaded tch datacard")

f_tuh_out = open('edited_2023aug18_sepScl_full_combined_tuh.txt', 'w')
f_tch_out = open('edited_2023aug18_sepScl_full_combined_tch.txt', 'w')
